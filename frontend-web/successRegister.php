...
<body>
    ...
    <header>
      ...
      <div id="loginform">
        <img src="img/logo-of.jpg" id="logo-form" alt="">
        <h1>Você foi cadastrado com sucesso, um email de confirmação foi enviado a você, acesse </br>seu email
            para confirmar seu cadastro e então realize o login para começar a jogar.
        </h1>
        <a href="login.php" id="submit" class="btn btn-outline-light">Login</a>
      </div>
